...
function Header() {
  return (
    <div
     className='min-h-screen mb-4 bg-cover bg-center flex items w-full overflow-hidden'
    ...
    >
        ...
        <motion.div
         ...
         viewport={{once:true}}
         className='text-white container text-center mx-auto py-4 px-6 md:px-20 lg:px-32 mt-15'>
